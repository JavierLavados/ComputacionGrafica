...
class SimpleShaderProgram:
    ...
    def drawShape(self, shape,transform, mode=GL_TRIANGLES):
        ...
        glUniformMatrix4fv(glGetUniformLocation(self.shaderProgram, "transform"), 1, GL_TRUE, transform)
...
# de aqui las funciones drawShape de las clases funcionan como drawShape(shape)
